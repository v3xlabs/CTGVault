// From: https://basescan.org/address/0x133b4e263ecdd2bb080fce39248f70ef734ccca7#code
export const CTG_TOKEN_ABI = [
    ...
    { inputs: [], name: 'ContractIdentityWrong', type: 'error' },
    {
        inputs: [
            {
                internalType: 'address',
    ...
    { inputs: [], name: 'InvalidTransferHook', type: 'error' },
    {
        inputs: [],
    ...
    { inputs: [], name: 'MintReferralNotSupported', type: 'error' },
    { inputs: [], name: 'MintToZeroAddress', type: 'error' },
    { inputs: [], name: 'MintZeroQuantity', type: 'error' },
    { inputs: [], name: 'Mint_SoldOut', type: 'error' },
    { inputs: [], name: 'NotAllowedToUpgrade', type: 'error' },
    ...
    { inputs: [], name: 'Purchase_SendFundsFailure', type: 'error' },
    ...
    { inputs: [], name: 'ZeroFundsRecipientNotAllowed', type: 'error' },
    {
        anonymous: false,
        inputs: [
            {
        ...
        inputs: [
            {
                indexed: false,
                internalType: 'address',
                name: '_newTransferHook',
                type: 'address',
            },
        ],
        name: 'SetNewTransferHook',
        type: 'event',
    },
    {
        anonymous: false,
        ...
        outputs: [
            {
                ...
                internalType: 'struct ICTGPlayerNFT.AddressMintDetails',
                name: '',
                type: 'tuple',
            },
        ],
    ...
    },
    {
        ...
        name: 'purchasePresaleWithRecipient',
        outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
        stateMutability: 'payable',
        type: 'function',
    },
        ...
        outputs: [
            {
                ...
                internalType: 'struct ICTGPlayerNFT.SaleDetails',
                name: '',
                type: 'tuple',
            },
        ],
    ...
    },
    {
        inputs: [
            ...
            { internalType: 'uint16', name: 'newRoyaltyBPS', type: 'uint16' },
        ],
        name: 'updateRoyaltySettings',
        outputs: [],
        stateMutability: 'nonpayable',
        type: 'function',
    },
