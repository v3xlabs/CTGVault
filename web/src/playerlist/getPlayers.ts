...
export const getPlayers = async (owner: string) => {
    const result = await fetch(`https://base-mainnet.g.alchemy.com/nft/v3/${ALCHEMY_API}/getNFTsForOwner?owner=${owner}&contractAddresses[]=${ctg_contract}&withMetadata=true&pageSize=100`, {
    });
